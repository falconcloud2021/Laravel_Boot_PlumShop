...
<link href="/shop/css/main.css" rel="stylesheet" type="text/css">
...
<link href="/shop/css/custom.css" rel="stylesheet" type="text/css">

<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="/shop/rs-plugin/css/settings.css" media="screen" />
...
<div id="loader">
  <div class="loader">
    <div class="position-center-center"> <img src="/shop/images/logo-dark.png" alt="">
...
<div id="wrap" class="construction"> 
  ...
  <header class="header-style-2 header-style-3"> 
    ...
    <div class="top-bar">
      <div class="container"> 
        <!-- Language -->
        <div class="language"> <a href="#." class="active">УКР</a> <a href="#.">РОС</a> <a href="#.">EN</a> </div>
        <div class="top-links">
          <ul>
    ...
    <div class="sticky">
    <div class="container">
      <div class="logo"> <a href="#."><img src="/shop/images/logo-dark.png" alt=""></a> </div>
              ...
              <ul class="megamenu full-width look-book">
                <li class="row nav-post">
                  ...
                  <div class="col-sm-5">
                    <div class="media">
                      <div class="media-left">
                        <div class="nav-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/nav-img-1.jpg" alt=""> </a> </div>
                      </div>
                    ...
                    <div class="media">
                      <div class="media-left">
                        <div class="nav-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/nav-img-4.jpg" alt=""> </a> </div>
                      </div>
                      <div class="media-body">
                        <h6 class="media-heading">Oversized T-Shirt Dress</h6>
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium </p>
                  ...
                  <div class="col-sm-5">
                    <div class="media">
                      <div class="media-left">
                        <div class="nav-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/nav-img-2.jpg" alt=""> </a> </div>
                      </div>
                      <div class="media-body">
                        <h6 class="media-heading">Oversized T-Shirt Dress</h6>
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium </p>
                    ...
                    <div class="media">
                      <div class="media-left">
                        <div class="nav-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/nav-img-3.jpg" alt=""> </a> </div>
                      </div>
                      <div class="media-body">
                        <h6 class="media-heading">Oversized T-Shirt Dress</h6>
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium </p>
          ...
          <li class="shop-cart"><a href="#."><i class="fa fa-shopping-cart"></i></a> <span class="numb">2</span>
            <ul class="dropdown">
              <li>
                <div class="media">
                  <div class="media-left">
                    <div class="cart-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/item-col-img-1.jpg" alt="..."> </a> </div>
                  </div>
                  <div class="media-body">
              ...
              <li>
                <div class="media">
                  <div class="media-left">
                    <div class="cart-img"> <a href="#"> <img class="media-object img-responsive" src="/shop/images/item-col-img-2.jpg" alt="..."> </a> </div>
                  </div>
                  <div class="media-body">
                    <h6 class="media-heading">DRAEY TRENCH COAT</h6>
                    <span class="price">129.00 USD</span> <span class="qty">QTY: 01</span> </div>
  ...
  <section class="home-slider">
    <div class="tp-banner-container">
      <div class="tp-banner-fix">
        <ul>
          <!-- Slider 1 -->
          <li data-transition="random" data-slotamount="7"> <img src="/shop/images/slides/slide-13.jpg" data-bgposition="center top" alt="" /> 
            <!-- Layer -->
            <div class="tp-caption sft font-montserrat tp-resizeme rs-parallaxlevel-4" 
                  ...
                  style="color: #ffffff; font-size: 72px; font-weight: bold; "> Welcome To Sebian </div>
            ...
            <div class="tp-caption sfb font-montserrat text-center tp-resizeme rs-parallaxlevel-4" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on" 
                  style="color: #fff; font-size: 14px; letter-spacing: 0px; line-height: 24px;"> There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in <br>
              some form, by injected humour, or randomised words</div>
            ...
            <div class="tp-caption sfb tp-resizeme rs-parallaxlevel-4" 
                  ...
                  data-endelementdelay="0.1" 
                  data-endspeed="300" 
                  data-captionhidden="on"> <a href="#." class="btn btn-corver"> Shop Now </a> </div>
          </li>
          
          <!-- Slider 1 -->
          <li data-transition="random" data-slotamount="7"> <img src="/shop/images/slides/slide-14.jpg" data-bgposition="center top" alt="" /> 
            <!-- Layer -->
            <div class="tp-caption sft font-montserrat tp-resizeme rs-parallaxlevel-4" 
                  data-x="center" 
                  data-y="center" data-voffset="-30" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on"
                  style="color: #272727; font-size: 72px; font-weight: bold; "> Welcome To Sebian </div>
            ...
            <div class="tp-caption sfb font-montserrat text-center tp-resizeme rs-parallaxlevel-4" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on" 
                  style="color: #272727; font-size: 14px; letter-spacing: 0px; line-height: 24px;"> There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in <br>
              some form, by injected humour, or randomised words</div>
    ...
    <div class="container"> 
      ...
      <div class="row"> 
        ...
        <div class="col-md-6  animate fadeInLeft" data-wow-delay="0.4s"> 
          ...
          <div class="news-post"> 
            <!-- Image --> 
            <img class="img-responsive" src="/shop/images/news-img-1.jpg" alt="" > <a href="#." class="news-tittle"> Canada Remodelling </a> 
            
            <!-- Dates -->
            <ul>
              <li>MAY 23 - 2015 </li>
              <li class="pull-right">COMMENT: 45 / VIEW: 686</li>
            </ul>
            ...
            <a class="read-more" href="#.">READ MORE <i class="ion-arrow-right-b"></i></a> </div>
        </div>
        ...
        <div class="col-md-6  animate fadeInRight" data-wow-delay="0.4s"> 
          ...
          <!-- News 1 -->
          <div class="media">
            <div class="media-left"> <a href="#" class="news-img"> <img class="media-object" src="/shop/images/news-img-2.jpg" alt=""> </a> </div>
            <div class="media-body"> <a href="#." class="news-tittle"> Alpha Construction Company </a>
          ...
          <!-- News 2 -->
          <div class="media">
            <div class="media-left"> <a href="#" class="news-img"> <img class="media-object" src="/shop/images/news-img-3.jpg" alt=""> </a> </div>
            <div class="media-body"> <a href="#." class="news-tittle"> Engineering/Construction </a>
              <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
              <!-- Dates -->
              <ul>
                <li>MAY 23 - 2015 </li>
          ...
          <!-- News 3 -->
          <div class="media">
            <div class="media-left"> <a href="#" class="news-img"> <img class="media-object" src="/shop/images/news-img-4.jpg" alt=""> </a> </div>
            <div class="media-body"> <a href="#." class="news-tittle"> Construction Claims Law Group </a>
              <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
              <!-- Dates -->
              <ul>
                <li>MAY 23 - 2015 </li>
  ...
  <section class="testimonial" data-stellar-background-ratio="0.7">
    <div class="section-p-60px overlay">
      <div class="container"> 
        ...
        <!-- Tittle -->
        <div class="tittle tittle-cont white  animate fadeInUp" data-wow-delay="0.4s">
        ...
        <div class="testi-slides  animate fadeInUp" data-wow-delay="0.4s"> 
          ...
          <!-- Slider 1 -->
          <div class="testi">
            <div class="avatar"> <img src="/shop/images/avatar-9.jpg" alt=""> </div>
          ...
          <!-- Slider 2 -->
          <div class="testi">
            <div class="avatar"> <img src="/shop/images/avatar-10.jpg" alt=""> </div>
          ...
          <!-- Slider 3 -->
          <div class="testi">
            <div class="avatar"> <img src="/shop/images/avatar-6.jpg" alt=""> </div>
            <p>“It is a long established fact that a reader will be distracted by the readable content of a page when 
              looking at its layout.”</p>
  ...
  <section class="section-p-60px our-clients">
    <div class="container"> 
      ...
      <div class="client-slide  animate fadeInUp" data-wow-delay="0.4s">
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-1.png" alt=""></a></div>
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-2.png" alt=""></a></div>
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-3.png" alt=""></a></div>
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-4.png" alt=""></a></div>
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-2.png" alt=""></a></div>
        <div class="slide"><a href="#."><img class="img-responsive" src="/shop/images/client-logo-4.png" alt=""></a></div>
      </div>
    </div>
  ...
  <footer>
    <div class="container">
      <div class="text-center"> <a href="#."><img src="/shop/images/logo.png" alt=""></a><br>
        <img class="margin-t-40" src="/shop/images/hammer-yellow.png" alt="">
        ...
        <div class="col-md-6">
          <ul class="row">
            ...
            <li class="col-sm-6">
              <h5>FLICKR PHOTO</h5>
              <ul class="flicker">
                <li><a href="#."><img src="/shop/images/flicker-1.jpg" alt=""></a></li>
                <li><a href="#."><img src="/shop/images/flicker-2.jpg" alt=""></a></li>
                <li><a href="#."><img src="/shop/images/flicker-3.jpg" alt=""></a></li>
                <li><a href="#."><img src="/shop/images/flicker-4.jpg" alt=""></a></li>
                <li><a href="#."><img src="/shop/images/flicker-5.jpg" alt=""></a></li>
                <li><a href="#."><img src="/shop/images/flicker-6.jpg" alt=""></a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <!-- Rights -->
      <div class="rights">
        <p>© 2023 All Rights Reserved. Powered By PLUM</p>
      </div>
    </div>
  </footer>  
  <!-- GO TO TOP --> 
...
<!-- Wrap End --> 
<script src="/shop/js/jquery-1.11.3.js"></script> 
<script src="/shop/js/wow.min.js"></script> 
<script src="/shop/js/bootstrap.min.js"></script> 
<script src="/shop/js/own-menu.js"></script> 
...
<script type="text/javascript" src="/shop/rs-plugin/js/jquery.themepunch.tools.min.js"></script> 
<script type="text/javascript" src="/shop/rs-plugin/js/jquery.themepunch.revolution.min.js"></script> 
